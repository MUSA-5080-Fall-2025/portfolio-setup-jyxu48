...
```{r}
ggplot(county_data) +
  aes(x = reorder(NAME, total_popE), y = total_popE) +
...
```{r}
# Perform the join 
# *left join: mostly used, preserved the first table
# *full join: union bound
# *inner join：join the only matched lines
