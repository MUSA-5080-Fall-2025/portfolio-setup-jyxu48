...
# Read a shapefile
pa_counties <- st_read("labs/lab2/week-04/data/Pennsylvania_County_Boundaries.shp")

# Read GeoJSON
districts <- st_read("labs/lab2/week-04/data/districts.geojson")
hospitals <- st_read("labs/lab2/week-04/data/hospitals.geojson")
...
hospital_buffers <- hospital_buffers %>%
  mutate(
