...
f5 <- Crime_Total_Count ~ Log_Ridership * is_weekend_factor + Alcohol_Count + Light_Count + Avg_Poverty + Avg_Vacancy +  log(Crime_Total_Count_lag) + Dist_Police + offset(log(Exposure_Days)) 
